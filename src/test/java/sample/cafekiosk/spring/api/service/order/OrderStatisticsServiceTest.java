...
//    private MailSendClient mailSendClient;
    ...
    void sendOrderStatisticsMail() {
        // given
        LocalDateTime now = LocalDateTime.of(2023, 11, 5, 0, 0);
        ...
        Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2023, 11, 4, 23, 59, 59), products);
        ...
        // when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2023, 11, 5), "test@test.com");
